      ...
      <div className="container">
        <div className="info-inner">
          <div className="info-text">
            <h2 className="title">{"<<В КАМНЕ>> - ЛИДЕР САНТК-ПЕТЕРБУРГА"}</h2>
            <p className="text">
              Наша компания является лидером в области работы с камнем. Мы предоставляем широкий спектр услуг по
              обработке, установке и реставрации камня.<br/><br/> Мы работаем с различными видами камня, включая
              гранит,
              мрамор,
              известняк и травертин. Наша команда профессионалов имеет богатый опыт работы с камнем и всегда готова
              предложить нашим клиентам лучшие решения для их проектов.<br/><br/>Мы предоставляем услуги по
              изготовлению
              столешниц, полов, каминов, ванных комнат и других элементов интерьера из камня. Мы также
              специализируемся
              на установке наружных элементов из камня, таких как площадки, ступени и дорожки.<br/><br/> Наша компания
              также
              предоставляет услуги по реставрации поврежденных каменных поверхностей. Мы используем только
